...
<body>
								...
								<div class="card-body p-4 p-lg-5 text-black">
									...
									<form action="mainpage">
										...
										<td class="form-label">User Name</td>
											<td><input type="text" id="form2Example17"
												class="form-control form-control-lg" name="username" />
												</td>
												 <!-- <label
												class="form-label" for="form2Example17"> User Name</label>
 -->
 ...
 -->
											...
											<button class="pt-1 mb-4 btn btn-dark btn-lg btn-block" type="button"
												onclick="return Validate()">
												<a href="/mainpage" style="color: white;">Login</a>
											</button>
										</div>
