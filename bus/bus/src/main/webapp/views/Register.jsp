...
<form action="registerthis">
  <div class="container">
    ...
    <input type="text" placeholder="Enter gender" name="DOB" id="DOB" required>
    
    <label for="CustomerType"><b>CustomerType</b></label>
    <input type="text" placeholder="Enter Customer Type" name="CustomerType" id="CustomerType" required>
